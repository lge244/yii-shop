...
<div class="row-fluid login-wrapper">
    ...
    <div class="span4 box">
        <div class="content-wrap">
            <h6>慕课商城 - 找回密码</h6>
            <?php echo $form->field($model, 'adminuser')->textInput(["class" => "span12", "placeholder" => "请输入您要找回的管理员账号"]); ?>
            <?php echo $form->field($model, 'adminemail')->textInput(["class" => "span12", "placeholder" => "管理员邮箱"]); ?>
            <a href="<?php echo yii\helpers\Url::to(['public/login']);?>" class="forgot">还回登陆?</a>
