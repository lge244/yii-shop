            ...
            <div class="col-xs-12 col-sm-6 no-margin">
                <ul class="right">
                    <?php if (\Yii::$app->session['user']['isLogin'] == 1): ?>
                        您好 , 欢迎您回来！<?php echo \Yii::$app->session['user']['loginName']; ?>！ , <a
                ...
                <div class="top-cart-row-container">
                    ...
                    <div class="top-cart-holder dropdown animate-dropdown">
                        ...
                        <span class="sign">￥</span><span
                                                class="value"><?php echo $this->params['cart']['total'] ?></span>
                    </span>
                                </div>
                            </a>
                                        ...
                                        <div class="basket-item">
                                            <div class="row">
                                                <div class="col-xs-4 col-sm-4 no-margin text-center">
                                                    <div class="thumb">
                                                        <a href="<?php echo yii\helpers\Url::to(['cart/index']) ?>"><img
                                                                    alt=""
                                                                    src="http://<?php echo $pro['cover'] ?>-logo"/></a>
                                                    </div>
                                                </div>
                                                <div class="col-xs-8 col-sm-8 no-margin">
                                                    <div class="title"><a
                                                                href="<?php echo yii\helpers\Url::to(['cart/index']) ?>"><?php echo $pro['title'] ?></a>
                                                    </div>
            ...
            <div class="container">
                <div class="yamm navbar">
                    ...
                    <div class="collapse navbar-collapse" id="mc-horizontal-menu-collapse">
                        <?php foreach ($this->params['menu'] as $pro): ?>
                            <ul class="nav navbar-nav">
                                <li class="dropdown">
                                    <a href="#" class="dropdown-toggle" data-hover="dropdown"
                                       data-toggle="dropdown"><?php echo $pro['title'] ?></a>
                                    <ul class="dropdown-menu">
                                        <?php foreach ($pro['children'] as $top): ?>
                                            <li>
                                                <div class="yamm-content">
                                                    <div class="row">
                                                        <div class="col-xs-12 col-sm-4">
                                                            ...
                                                            <ul>
                                                                <li>
                                                                    <a href="<?php echo yii\helpers\Url::to(['product/index', 'cateid' => $top['cateid']]) ?>">各种品牌</a>
                                                                </li>
                                                            </ul>
                                                        </div><!-- /.col -->
