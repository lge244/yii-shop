                    ...
                    <div class="row field-row" style="margin-top:10px">
                        <div class="col-xs-12">
                            <input class="le-radio big address" type="radio" name="address"
                                   value="<?php echo $address['addressid'] ?>" <?php if ($key == 0) {
                                echo 'checked = "checked"';
                            } ?> />
                            <a class="simple-link bold"
                               href="#"><?php echo $address['firstname'] . $address['lastname'] . " " . $address['company'] . " " . $address['address'] . " " . $address['postcode'] . " " . $address['email'] . " " . $address['telephone'] ?></a>
                        </div>
                        <a style="margin-left:45px"
                           href="<?php echo yii\helpers\Url::to(['address/del', 'addressid' => $address['addressid']]) ?>">删除</a>
                    </div><!-- /.field-row -->
                <?php endforeach; ?>
                    ...
                    <div class="row no-margin order-item">
                        <div class="col-xs-12 col-sm-1 no-margin">
                            <a href="<?php echo yii\helpers\Url::to(['product/detail', 'productid' => $product['productid']]) ?>"
                               class="qty"><?php echo $product['productnum'] ?> x</a>
                        </div>
                        ...
                        <div class="col-xs-12 col-sm-9 ">
                            ...
                            <div class="title">
                                ...
                                <a href="<?php echo yii\helpers\Url::to(['product/detail', 'productid' => $product['productid']]) ?>"
                                   class="thumb-holder">
                                    <img class="lazy" alt="" src="http://<?php echo $product['cover'] ?>-logo"/>
                                </a>
                                <a style="margin-left:50px"
                                   href="<?php echo yii\helpers\Url::to(['product/detail', 'productid' => $product['productid']]) ?>"><?php echo $product['title'] ?></a>
                            </div>
                        </div>
                                ...
                                <div style="width:100%;text-align:right" class="value">
                                    <div class="radio-group">
                                        <?php foreach ($express as $k => $e): ?>
                                            <?php $checked = "";
                                            if ($k == 2) $checked = "checked" ?>
                                            <input class="le-radio express" type="radio" name="expressid"
                                                   value="<?php echo $k ?>"
                                                   data="<?php echo $expressPrice[$k] ?>" <?php echo $checked ?>>
                                            <div class="radio-label bold"><?php echo $e ?><span
                                                        class="bold"> ￥ <?php echo $expressPrice[$k] ?></span></div><br>
                                        <?php endforeach; ?>
                                    </div>
                                </div>
                            </li>
                        ...
                        <ul id="total-field" class="tabled-data inverse-bold ">
                            <li>
                                ...
                                <div class="value" style="width:100%;text-align:right" id="ototal">￥
                                    <span><?php echo $total + 20 ?></span></div>
                            </li>
                        </ul><!-- /.tabled-data -->
